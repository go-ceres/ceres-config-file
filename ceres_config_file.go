...
func (fs *fileSource) Read() (*CeresConfig.DataSet, error) {
...
func (fs *fileSource) Write(dataSet *CeresConfig.DataSet) error {
	return nil
}
...
func NewSource(file string, opts ...Option) CeresConfig.Source {
